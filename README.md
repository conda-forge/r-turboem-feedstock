About r-turboem-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-turboem-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1758&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-turboem-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-turboem` can be installed with `conda`:
...
```
mamba install r-turboem
```

It is possible to list all of the versions of `r-turboem` available on your platform with `conda`:
...
```
mamba search r-turboem --channel conda-forge
```
...
mamba repoquery search r-turboem --channel conda-forge

# List packages depending on `r-turboem`:
mamba repoquery whoneeds r-turboem --channel conda-forge

# List dependencies of `r-turboem`:
mamba repoquery depends r-turboem --channel conda-forge
```
